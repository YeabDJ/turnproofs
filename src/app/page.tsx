          ...
          <div className="grid grid-cols-1 lg:grid-cols-[1fr_2.5fr_1fr] gap-4 items-center">
            ...
            <div className="hidden lg:flex flex-col items-center justify-center relative h-64 animate-float-left">
              <div className="relative p-3.5 rounded-2xl bg-[#131720]/75 border border-[#FF4F2B]/35 shadow-2xl shadow-orange-500/10">
                ...
                {/* Standalone map pin badge — floats to the right */}
                <div className="absolute top-1/2 -translate-y-1/2 -right-10 flex flex-col items-center gap-0.5 animate-bounce">
                  <svg width="22" height="30" viewBox="0 0 22 30" fill="none" xmlns="http://www.w3.org/2000/svg" className="drop-shadow-[0_2px_6px_rgba(255,79,43,0.7)]">
                    <path d="M11 0C4.925 0 0 4.925 0 11C0 19.25 11 30 11 30C11 30 22 19.25 22 11C22 4.925 17.075 0 11 0Z" fill="#FF4F2B"/>
