...
import { Play, Pause, QrCode, FileText, CheckCircle2, RotateCcw } from 'lucide-react';
  ...
  return (
    <div className="max-w-4xl mx-auto rounded-3xl bg-neutral-900 border border-neutral-800 p-2.5 sm:p-5 shadow-2xl shadow-rose-500/5 relative overflow-hidden group">
      ...
      <div className="aspect-video w-full rounded-2xl overflow-hidden bg-neutral-950 relative border border-neutral-850 flex flex-col justify-between p-3.5 sm:p-6 select-none">
        ...
        {/* Top Video Header Overlay (Fully Mobile Responsive) */}
      ...
      <div className="mt-3.5 grid grid-cols-1 sm:grid-cols-3 gap-2.5 pt-3 border-t border-neutral-850 text-center sm:text-left px-1">
        <div 
          ...
          className={`p-2.5 rounded-xl border transition-all cursor-pointer ${activeStep === 1 ? 'border-rose-500/50 bg-rose-500/10' : 'border-neutral-850 bg-neutral-950/40 hover:border-neutral-750'}`}
        >
          <div className="flex items-center gap-2.5">
        ...
        <div 
          ...
          className={`p-3 rounded-xl border transition-all cursor-pointer ${activeStep === 2 ? 'border-orange-500/50 bg-orange-500/10' : 'border-neutral-850 bg-neutral-950/40 hover:border-neutral-750'}`}
        >
          <div className="flex items-center gap-2.5">
        ...
        <div 
          ...
          className={`p-3 rounded-xl border transition-all cursor-pointer ${activeStep === 3 ? 'border-emerald-500/50 bg-emerald-500/10' : 'border-neutral-850 bg-neutral-950/40 hover:border-neutral-750'}`}
        >
          <div className="flex items-center gap-2.5">
